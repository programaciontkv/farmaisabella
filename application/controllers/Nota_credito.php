		...
		foreach ($cns as $rst_det) {
			$n++;
		        ...
		        $detalle.="<tr>
                                            ...
                                            <td width='5px' ><input type='text' id='iva$n' name='iva$n'  style='text-align:right' class='form-control' value='$rst_det->dfc_iva' lang='$n' readonly /></td>
